...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_60_ansi_split_space_bs_shifts(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
    C_MTCE,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
    MO(1),   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT, TO(1),
    KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,           MO(1),            KC_SPC,           KC_LALT, KC_RGUI, TO(1),   KC_RCTL),
  ...
  LAYOUT_60_ansi_split_space_bs_shifts(
    ...
    TO(0),   KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, _______,
    _______, MO(2),   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, KC_BTN2,          _______,          KC_BTN1,          _______,          KC_BTN2, _______, TO(0),   _______),
  ...
  LAYOUT_60_ansi_split_space_bs_shifts(
    ...
    _______, _______, X(SNEK), _______, X(FLEX), _______, _______, _______, _______, _______, _______, _______, _______,
